...
def generate_taxonomy(doc_title, section_text):
    ...
    You are helping to discern taxonomy data from the from each of the sections
    Your output should be 

    - components: list of components referenced in the section, in order of relevance
    - tags: subjects of the section
    - type: information, configuration, maintenance, diagnosis, servicing. removal
